...
public class App_Tab_1 extends ChartViewTab {
    ...
    private void loadDataFromSharedPreference() {
        ...
        statisticId = sharedPreferences.getInt("STATISTIC1ID", 0);
        period = sharedPreferences.getString("STATISTIC1PERIOD", null);
        statisticName = sharedPreferences.getString("STATISTIC1NAME", null);
    }
    ...
    private void loadDataFromServer() {
            ...
            try {
                ...
                System.out.println("AppTab1: Float Values Period: -------------------------------" + floatValuesPeriod);
                ...
                System.out.println("AppTab1: Float Values PrePeriod: -------------------------------" + floatValuesPrePeriod);
            ...
            */
                ...
                System.out.println("AppTab1: Float Values Anomaly: -------------------------------" + floatValuesAnomaly);
