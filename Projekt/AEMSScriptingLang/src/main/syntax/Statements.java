...
public class Statements {
	...
	public static final Object[] RAISE_WARNING_SIMPLE = toArray("raise", "warning", TokenTypes.STRING, "on", TokenTypes.ANY_END);
	...
	public static final Object[] TITLE_PREPROCESSOR = toArray(TokenTypes.AT, "title", TokenTypes.STRING);
