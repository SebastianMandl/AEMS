 ...
 * @author Sebastian
 */
public class StatisticMeter extends GraphQLObjectType {
    
//    statistic_id numeric(10,0) NOT NULL,
//  meter_id character varying(150) NOT NULL,
    
    private static StatisticMeter instance;
    ...
    public StatisticMeter(String name, String description, List<GraphQLFieldDefinition> fieldDefinitions, List<GraphQLOutputType> interfaces) {
        super(name, description, fieldDefinitions, interfaces);
    }
    
    public static StatisticMeter getInstance() {
        if(instance != null)
            return instance;
        ...
        instance = new StatisticMeter("statistic_meter", "", defs, new ArrayList<GraphQLOutputType>());
        return instance;
    }
}
