...
/**
 * This class provides encryption functionality. It encrypts using the AES
 * Algorithm.
 * 
...
public class Encrypter {
     ...
     * @param raw
     *            - the raw bytes which shell be encrypted
     * @return the encrypted byte array version of the raw byte array passed into
     *         this function.
     ...
     *             the integrity of the encryption functionality.
     * @throws NoSuchPaddingException
     *             - if the padding is not proper
     */
    public static byte[] requestEncryption(byte[] key, byte[] raw) throws IllegalBlockSizeException,
    ...
    public static byte[] requestEncryption(BigDecimal key, byte[] raw) throws IllegalBlockSizeException,
            BadPaddingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException {
